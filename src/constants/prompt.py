...
*IMPORTANT: One key value pair should be one entity. For example "bulgaria ms milena boykova" is invalid. The key shold not be any generic result like "Bank" is not valid company name.
*IMPORTANT: If there is no result then simply return empty json without any key value pair.
